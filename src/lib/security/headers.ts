...
export const securityHeaders = {
  'Content-Security-Policy':
    ...
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' " +
      ...
      "fundingchoicesmessages.google.com go.ezoic.net g.ezoic.net go.ezodn.com www.ezojs.com " +
      "cmp.gatekeeperconsent.com the.gatekeeperconsent.com secure.quantserve.com rules.quantcount.com " +
      // — Adsterra banner & social bar scripts:
      "*.profitableratecpm.com *.highperformanceformat.com; " +
    ...
    "img-src 'self' data: https: blob: " +
      "https://go.ezoic.net https://g.ezoic.net https://go.ezodn.com https://pixel.quantcount.com; " +
    ...
    "connect-src 'self' ws: wss: " +
      ...
      "*.doubleclick.net go.ezoic.net g.ezoic.net go.ezodn.com www.ezojs.com " +
      "cmp.gatekeeperconsent.com the.gatekeeperconsent.com https://pixel.quantserve.com; " +
